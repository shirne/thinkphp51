 ...
 * @package think
 * @mixin Query
 * @method static $this scope(string|array $scope) 查询范围
 * @method static $this where(mixed $field, string $op = null, mixed $condition = null) 查询条件
 * @method static $this whereRaw(string $where, array $bind = [], string $logic = 'AND') 表达式查询
 * @method static $this whereExp(string $field, string $condition, array $bind = [], string $logic = 'AND') 字段表达式查询
 * @method static $this when(mixed $condition, mixed $query, mixed $otherwise = null) 条件查询
 * @method static $this join(mixed $join, mixed $condition = null, string $type = 'INNER', array $bind = []) JOIN查询
 * @method static $this view(mixed $join, mixed $field = null, mixed $on = null, string $type = 'INNER') 视图查询
 * @method static $this with(mixed $with, callable $callback = null) 关联预载入
 * @method static $this count(string $field = '*') Count统计查询
 * @method static $this min(string $field, bool $force = true) Min统计查询
 * @method static $this max(string $field, bool $force = true) Max统计查询
 * @method static $this sum(string $field) SUM统计查询
 * @method static $this avg(string $field) Avg统计查询
 * @method static $this field(mixed $field, boolean $except = false, string $tableName = '', string $prefix = '', string $alias = '') 指定查询字段
 * @method static $this fieldRaw(string $field) 指定查询字段
 * @method static $this union(mixed $union, boolean $all = false) UNION查询
 * @method static $this limit(mixed $offset, integer $length = null) 查询LIMIT
 * @method static $this order(mixed $field, string $order = null) 查询ORDER
 * @method static $this orderRaw(string $field, array $bind = []) 查询ORDER
 * @method static $this cache(mixed $key = null , integer|\DateTime $expire = null, string $tag = null) 设置查询缓存
 * @method static mixed value(string $field, mixed $default = null) 获取某个字段的值
 * @method static array column(string $field, string $key = '') 获取某个列的值
 * @method static $this find(mixed $data = null) 查询单个记录
 * @method static $this findOrFail(mixed $data = null) 查询单个记录
 * @method static Collection|$this[] select(mixed $data = null) 查询多个记录
 * @method static $this get(mixed $data = null,mixed $with = [],bool $cache = false, bool $failException = false) 查询单个记录 支持关联预载入
 * @method static $this getOrFail(mixed $data = null,mixed $with = [],bool $cache = false) 查询单个记录 不存在则抛出异常
 * @method static $this findOrEmpty(mixed $data = null) 查询单个记录  不存在则返回空模型
 * @method static Collection|$this[] all(mixed $data = null,mixed $with = [],bool $cache = false) 查询多个记录 支持关联预载入
 * @method static $this withAttr(array $name,\Closure $closure = null) 动态定义获取器
 * @method static $this withJoin(string|array $with, string $joinType = '')
 * @method static $this withCount(string|array $relation, bool $subQuery = true) 关联统计
 * @method static $this withSum(string|array $relation, string $field, bool $subQuery = true) 关联SUM统计
 * @method static $this withMax(string|array $relation, string $field, bool $subQuery = true) 关联MAX统计
 * @method static $this withMin(string|array $relation, string $field, bool $subQuery = true) 关联Min统计
 * @method static $this withAvg(string|array $relation, string $field, bool $subQuery = true) 关联Avg统计
 * @method static Paginator|$this paginate() 分页
 */
