 ...
 * @see \think\Validate
 * @mixin \think\Validate
 * @method static \think\Validate make(array $rules = [], array $message = [], array $field = []) 创建一个验证器类
 * @method static \think\Validate rule(mixed $name, mixed $rule = '') 添加字段验证规则
 * @method static void extend(string $type, mixed $callback = null) 注册扩展验证（类型）规则
 ...
 * @method static bool check(array $data, mixed $rules = [], string $scene = '') 数据自动验证
 * @method static mixed getError(mixed $value, mixed $rule) 获取错误信息
 */
